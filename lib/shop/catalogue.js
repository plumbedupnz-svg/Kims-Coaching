...
const SETTINGS_FIELDS = 'hide_out_of_stock,pickup_label,pickup_instructions,local_delivery_enabled,local_delivery_fee,courier_delivery_enabled,courier_delivery_fee,free_shipping_threshold,tax_mode,tax_label,tax_rate_percent,prices_include_tax,stripe_automatic_tax';
let cached, pending;
