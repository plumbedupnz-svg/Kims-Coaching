-- Add lesson type booking rules for class viability and pay-as-you-go lessons.
...
alter table public.lesson_types
drop constraint if exists lesson_types_minimum_players_positive;

alter table public.lesson_types
add constraint lesson_types_minimum_players_positive
...
as $$
  ...
  expanded_slots as (
    select
      ...
      greatest(1, coalesce(lesson_types.minimum_players, private_lesson.minimum_players, 1)) as lesson_type_minimum_players,
