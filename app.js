...
document.addEventListener("click", (event) => {
  ...
  if (!target.closest("[data-product-qr-panel], [data-product-qr], [data-product-qr-download], [data-product-qr-print], [data-product-qr-close]")) {
    closeProductQrPanels();
  }
});

document.addEventListener("keydown", (event) => {
  if (event.key === "Escape") closeProductQrPanels();
});
